      ...
      <footer className="bg-white border-t border-slate-200 py-6 mt-12">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Enterprise Secure Session</span>
          </div>
          <div className="flex items-center gap-1.5 group">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Idea developed by</span>
            <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest px-2 py-1 bg-indigo-50 rounded-lg group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
              Ashish Ahuja
            </span>
          </div>
        </div>
